...
var config = URL + 'App/Notoken/config';
...
var pay_paysapi = URL + 'App/PaysApi/create_order';
//重新领取任务-10状态的
...
var get_notice_summary = URL + 'App/User/notice_summary';
...
var xw_game_url = URL + '/App/Game/xw_game_url'; //获取闲玩游戏链接
var user_cert = URL + '/App/User/cert'; //用户实名认证
